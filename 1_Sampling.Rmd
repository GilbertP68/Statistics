...
# Sample with different n values
some_income20 <- sample_income(20)
some_income100 <- sample_income(100)
...
# Boxplot summaries
boxplot(some_income20)
boxplot(some_income100)

#----------------------------------#

# Sample with different n values
some_nuggety20 <- sample_nuggety(20)
some_nuggety100 <- sample_nuggety(100)


# Histogram summaries
hist(some_nuggety20)
hist(some_nuggety100)

# Boxplot summaries
boxplot(some_nuggety20)
boxplot(some_nuggety100)
